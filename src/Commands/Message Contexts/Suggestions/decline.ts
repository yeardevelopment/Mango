  ...
  run: async ({ interaction }) => {
    ...
    if (
      ...
      return interaction.reply({
        content: '⚠️ The suggestions system is not set up properly yet.',
        ephemeral: true,
      });
    ...
    if (target.embeds[0].hexColor === '#e03c3c')
      return interaction.reply({
        content:
          '<:cancel:996733678279462932> The suggestion is already declined.',
        ephemeral: true,
      });
